...
namespace FastGraph
{
    ...
    public delegate bool TryFunc<in T, TResult>(T arg, [NotNullWhen(true)] out TResult? result);
    ...
    /// <param name="result">The result of the method if it succeed.</param>
    /// <returns>Boolean indicating if the method succeeded or not.</returns>
    public delegate bool TryFunc<in T1, in T2, TResult>(T1 arg1, T2 arg2, [NotNullWhen(true)] out TResult? result);
    ...
    /// <param name="result">The result of the method if it succeed.</param>
    /// <returns>Boolean indicating if the method succeeded or not.</returns>
    public delegate bool TryFunc<in T1, in T2, in T3, TResult>(T1 arg1, T2 arg2, T3 arg3, [NotNullWhen(true)] out TResult? result);
    ...
    /// <param name="result">The result of the method if it succeed.</param>
    /// <returns>Boolean indicating if the method succeeded or not.</returns>
    public delegate bool TryFunc<in T1, in T2, in T3, in T4, TResult>(T1 arg1, T2 arg2, T3 arg3, T4 arg4, [NotNullWhen(true)] out TResult? result);
}
