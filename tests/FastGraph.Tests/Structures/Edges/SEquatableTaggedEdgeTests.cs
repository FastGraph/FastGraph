...
#pragma warning disable CS8625
            Assert.Throws<ArgumentNullException>(() => new SEquatableTaggedEdge<TestVertex, TestObject>(default, new TestVertex("v1"), default));
            Assert.Throws<ArgumentNullException>(() => new SEquatableTaggedEdge<TestVertex, TestObject>(new TestVertex("v1"), default, default));
            Assert.Throws<ArgumentNullException>(() => new SEquatableTaggedEdge<TestVertex, TestObject>(default, default, default));
#pragma warning restore CS8625
        ...
        public void Equals()
        {
            ...
            Assert.IsTrue(edge1.Equals(default));
        }
