...
#pragma warning disable CS8625
            Assert.Throws<ArgumentNullException>(() => new SEquatableEdge<TestVertex>(default, new TestVertex("v1")));
            Assert.Throws<ArgumentNullException>(() => new SEquatableEdge<TestVertex>(new TestVertex("v1"), default));
            Assert.Throws<ArgumentNullException>(() => new SEquatableEdge<TestVertex>(default, default));
