...
#pragma warning restore CS8625
        ...
        public void StronglyConnectedComponents(TestGraphInstance<AdjacencyGraph<string, Edge<string>>, string> testGraph)
        {
            RunStronglyConnectedComponentsAndCheck(testGraph.Instance);
        }

        private static IEnumerable<TestCaseData> AdjacencyGraphs_All =
            TestGraphFactory
